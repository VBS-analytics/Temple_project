...
# Trust proxy headers (Render/load balancer) so Django builds absolute URLs with HTTPS.
...
MIDDLEWARE = [
    ...
    'temple_backend.middleware.ReadOnlyAdminWriteBlockMiddleware',
...
# Temple calendar configuration
TEMPLE_LATITUDE = float(os.environ.get("TEMPLE_LATITUDE", "10.7722"))  # Thiruvarur
