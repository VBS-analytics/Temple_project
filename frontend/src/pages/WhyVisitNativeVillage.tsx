    ...
    <main className="relative overflow-x-hidden senior-readable-content">
      ...
      <div className="relative min-h-[70vh] px-4 pt-14 pb-8 sm:px-6 sm:pt-16 sm:pb-10 md:pt-16 md:pb-12 lg:px-8">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8 md:space-y-10">
          ...
          <section className="group bg-[#fffdf8] rounded-2xl sm:rounded-3xl border border-[#efd9cf] shadow-sm hover:shadow-xl hover:border-[#a33a2b] transition-all duration-500 p-4 sm:p-6 md:p-8 relative overflow-hidden">
            {/* Decorative corner */}
            <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-[#f8eee2] to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

            {/* Icon badge */}
            <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-5">
              <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center text-xl sm:text-2xl group-hover:scale-110 transition-transform duration-300" style={{ background: "#efd9cf" }}>
                <BlessingIcon />
              </div>
            ...
            <div className="space-y-3 sm:space-y-4 text-[#5f4636]">
              ...
              <div className="mt-4 sm:mt-5 p-3 sm:p-4 bg-[#f8eee2]/70 rounded-xl border border-[#efd9cf]">
                <p className="text-xs sm:text-sm font-medium text-[#7a5e4b] flex items-start gap-2 mb-2 sm:mb-3">
                  ...
                  <span className="break-all">
                    <span className="font-semibold text-[#5f4636]">Audio Reference</span>{" "}                  </span>
                </p>
          ...
          {/* Call to Action */}
          <div className="mt-8 sm:mt-10 md:mt-12 p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg text-center relative overflow-hidden" style={{ background: "linear-gradient(135deg, #a33a2b 0%, #7e2a20 100%)" }}>
            {/* Decorative circles */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center max-w-md sm:max-w-none mx-auto px-2">
                <a
                  href="/kovi-details"
                  className="px-5 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 rounded-xl sm:rounded-2xl bg-white text-[#7e2a20] font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 w-full sm:w-auto text-center"
                >
                  About Kovil
                </a>
                <a
                  href="/"
                  className="px-5 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 rounded-xl sm:rounded-2xl bg-transparent border-2 border-white text-white font-semibold text-sm sm:text-base hover:bg-white hover:text-[#7e2a20] transition-all duration-300 w-full sm:w-auto text-center"
                >
                  Return Home
                </a>
              </div>
